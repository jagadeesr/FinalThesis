...
\prod_{l=1}^d \biggl[
1 - \eta g_r(x_l,t_l) \biggr], % \quad  g_r(x,t) := (-1)^{r} B_{2r}( |{x-t}| \bmod 1 ) 
\\
& = 
\sum_{j=1}^d  
\prod_{l=1, l \neq j}^d \biggl[
1 - \eta g_r(x_l,t_l) \biggr]
...
\sum_{j=1}^d 
\frac{
	\biggl(1 - \eta g_r({x_j,t_j})  - 1 \biggr)
}{
	1 - \eta g_r(x_j,t_j) 
}
\\
...
\frac{1}{\eta_j}
\frac{
	\biggl(1 - \eta_j g_r(x_j,t_j)  - 1 \biggr)
}{
	1 - \eta_j g_r(x_j,t_j) 
}
\\
...
\prod_{l=1}^d [ 1 - \eta_l g_r(x_l,t_l) ]$.
