...
\Section{Test Results and Observations for Algorithm1} % for \code{cubBayesLattice\_g}}
...
\Section{Test Results and Observations for Algorithm2} % \code{cubBayesNet\_g}}
